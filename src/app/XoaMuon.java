 ...
 * @author trant
 */
public class XoaMuon extends javax.swing.JFrame {

    private ConnectionDB connectDB;
    private Connection connect;
    /**
     * Creates new form XoaMuon
     */
    public XoaMuon() {
        initComponents();
        setLocationRelativeTo(null);
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        this.setTitle("Xóa thông tin mượn");
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(txtMaM, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String mamuon = txtMaM.getText();
        String sql = "delete from muon where mamuon='"+mamuon+"';";
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(XoaMuon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
